...
import com.yrkj.artaskgame.cmobile.control.CheckUserTaskDao.TaskDaoResult;
...
public class CheckUserTaskDao extends BaseTaskDao<Integer, Object, TaskDaoResult> {

    public static final String BIZID = "CheckUserTaskDao";
    public PostTaskListener postl = null;
    public PreTaskListener prel = null;
    public RunningTaskListener running = null;
    protected CheckUserTaskDao mDao = null;
   
    public CheckUserTaskDao(String urlPath){
         mURLPath = urlPath;
    }
    
    public CheckUserTaskDao addGetParams( 
       ){
        return this;
    }

    public CheckUserTaskDao addPostParams(
    		String method,
    		String username,
    		String userid
    		){
    ...
    public CheckUserTaskDao addFileParams(
    ){
        return this;
    }

    private void run(int id){
         mDao = new CheckUserTaskDao(mURLPath);
         //Init
