...
import com.yrkj.artaskgame.acty.qcar.SampleAppMenu.SampleAppMenuGroup;
import com.yrkj.artaskgame.acty.qcar.SampleAppMenu.SampleAppMenuInterface;
...
//    }
    ...
    {
        private final WeakReference<QCARInitActivityActy> mImageTargets;
        
        
        LoadingDialogHandler(QCARInitActivityActy imageTargets)
        {
            mImageTargets = new WeakReference<QCARInitActivityActy>(imageTargets);
        }
        
        
        public void handleMessage(Message msg)
        {
        	QCARInitActivityActy imageTargets = mImageTargets.get();
...
//                imageTargets.mLoadingDialogContainer.setVisibility(View.GONE);
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            {
                QCAR.setInitParameters(QCARInitActivityActy.this, mVuforiaFlags);
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            } else
            {
                ...
                AlertDialog dialogError = new AlertDialog.Builder(
                		QCARInitActivityActy.this).create();
...
//        setContentView(R.layout.activity_launch);
        ...
        loadTextures();
        QCARInitActivity.getInstance().setTextures(mTextures);
...
//    public static native void startCamera(int camera);
//    public static native void stopCamera();
//    public static native void setProjectionMatrix();
//    public static native boolean startExtendedTracking();
//    public static native boolean stopExtendedTracking();
...
//    public static native void switchDatasetAsap(int datasetId);
//    public static native boolean autofocus();
//    public static native boolean setFocusMode(int mode);
//    public static native boolean activateFlash(boolean flash);
