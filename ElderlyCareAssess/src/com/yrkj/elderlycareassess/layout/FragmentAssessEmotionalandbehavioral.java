...
public class FragmentAssessEmotionalandbehavioral extends BaseLayout{
    ...
    public FragmentAssessEmotionalandbehavioral(Activity acty){
        mCurActy = acty;
        mContainer = (android.widget.FrameLayout) acty.findViewById(ContainerId);
    }   

    public FragmentAssessEmotionalandbehavioral(android.view.View acty){
        mContainer = (android.widget.FrameLayout) acty.findViewById(ContainerId);
    }   
