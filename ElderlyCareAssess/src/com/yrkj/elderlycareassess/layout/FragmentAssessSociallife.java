...
public class FragmentAssessSociallife extends BaseLayout{
    ...
    public FragmentAssessSociallife(Activity acty){
        mCurActy = acty;
        mContainer = (android.widget.FrameLayout) acty.findViewById(ContainerId);
    }   

    public FragmentAssessSociallife(android.view.View acty){
        mContainer = (android.widget.FrameLayout) acty.findViewById(ContainerId);
    }   
