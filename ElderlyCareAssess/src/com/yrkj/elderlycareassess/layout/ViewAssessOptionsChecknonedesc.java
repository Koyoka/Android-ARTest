...
public class ViewAssessOptionsChecknonedesc extends BaseLayout{
    ...
    public ViewAssessOptionsChecknonedesc(Activity acty){
        mCurActy = acty;
        mLayoutNormalContentView = (android.widget.LinearLayout) acty.findViewById(LayoutNormalContentViewId);
    }   

    public ViewAssessOptionsChecknonedesc(android.view.View acty){
        mLayoutNormalContentView = (android.widget.LinearLayout) acty.findViewById(LayoutNormalContentViewId);
    }   
