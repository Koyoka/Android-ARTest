...
public class UIRecordButton extends Button {

	public UIRecordButton(Context context) {
		super(context);
		init();
	}

	public UIRecordButton(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public UIRecordButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
