...
public class LockSetupActivity extends Activity implements
	...
	public static final String INITENT_KEY_LOGIN = "Login";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent != null && intent.getBooleanExtra(INITENT_KEY_LOGIN, false)){
        	isLogin = true;
        }
        ...
        mDescView = (TextView)findViewById(R.id.txtStepDescView);
